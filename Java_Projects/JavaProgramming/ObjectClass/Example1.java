 ...
 * 
 * Let's take an example, there is getObject() method that returns an object but
 * it can be of any type like Employee,Student etc, we can use Object class
 * reference to refer that object
 */

// Object obj=getObject();//we don't know what object will be returned from this
// method
 ...
 * method).
 * public final void wait()throws InterruptedException causes the current thread
 * to wait, until another thread notifies (invokes notify() or notifyAll()
 * method).
